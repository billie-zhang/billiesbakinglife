...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="pt-32 md:pt-48 px-8 md:px-20 mb-32">
      ...
      <section className="max-w-7xl mx-auto px-10 mb-52">
        <div className="flex items-center gap-8 mb-16">
          <h2 className="text-3xl font-serif italic text-[#2D334A] whitespace-nowrap">latest from the kitchen</h2>
          <div className="w-full h-[1.5px] bg-[#D1DAFF]/70" />
        </div>
